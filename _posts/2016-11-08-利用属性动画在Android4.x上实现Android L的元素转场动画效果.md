...
#### <font color=#ff0000>关键动画之 ObjectAnimator - positionAnimator 实现：改变ImageView的位置和大小</font>
...
#### <font color=#ff0000>关键动画之ObjectAnimator - matrixAnimator：使ImageView展示的图片呈现渐变效果</font>
