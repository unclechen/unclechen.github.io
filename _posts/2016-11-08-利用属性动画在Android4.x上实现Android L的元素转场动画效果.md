---
layout: post
title: 利用属性动画在Android4.x上实现Android L的元素转场效果（shared elements transition）
date: '2016-11-08'
---
...
#### 关键动画之 ObjectAnimator - positionAnimator 实现：改变ImageView的位置和大小
...
#### 关键动画之ObjectAnimator - matrixAnimator：使ImageView展示的图片呈现渐变效果
